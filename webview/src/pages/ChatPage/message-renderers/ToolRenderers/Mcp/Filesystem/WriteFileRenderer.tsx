...
class WriteFileToolUseDto extends ToolUseBlockDto {
    declare input: {
        path: string;
        content: string;
    };
...
export function WriteFileRenderer(props: RendererProps) {
    const {t} = useTranslation('chatTools');
    const {toolUse: rawToolUse, toolResult} = props;
    const toolUse = rawToolUse as unknown as WriteFileToolUseDto;
