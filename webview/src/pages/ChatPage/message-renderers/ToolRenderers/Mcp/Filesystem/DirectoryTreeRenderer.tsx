...
class DirectoryTreeToolUseDto extends ToolUseBlockDto {
    declare input: {
        path: string;
...
export function DirectoryTreeRenderer(props: RendererProps) {
    const {t} = useTranslation('chatTools');
    const {toolUse: rawToolUse, toolResult} = props;
    const toolUse = rawToolUse as unknown as DirectoryTreeToolUseDto;
