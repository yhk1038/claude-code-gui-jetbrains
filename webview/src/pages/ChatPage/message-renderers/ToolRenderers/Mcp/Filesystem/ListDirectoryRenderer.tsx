...
class ListDirectoryToolUseDto extends ToolUseBlockDto {
    declare input: {
        path: string;
        sortBy?: 'name' | 'size';
    };
...
export function ListDirectoryRenderer(props: RendererProps) {
    const {t} = useTranslation('chatTools');
    const {toolUse: rawToolUse, toolResult} = props;
    const toolUse = rawToolUse as unknown as ListDirectoryToolUseDto;
