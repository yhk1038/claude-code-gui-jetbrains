...
export const CLAUDE_MODELS: ClaudeModelDef[] = [
  ...
  { key: ClaudeModel.SONNET,  id: 'claude-sonnet-4-7',          label: 'Sonnet 4.7',            description: 'Best for everyday tasks' },
  { key: ClaudeModel.HAIKU,   id: 'claude-haiku-4-5-20251001',  label: 'Haiku 4.5',             description: 'Fastest for quick answers' },
  { key: ClaudeModel.OPUS,    id: 'claude-opus-4-7',            label: 'Opus 4.7',              description: 'Most capable for complex work' },
];
